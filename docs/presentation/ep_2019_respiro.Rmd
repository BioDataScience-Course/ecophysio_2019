...
- 1h30  :Recherche bibliographique sur l'utilisation de la respirométrie sur des organismes aquatiques (plante, coraux, oursins, ...)
...
plot(measure1$Time, measure1$O2_2N, type = "l",ylab = "Concentration en oxygène (mg/L)", xlab="Temps")
...
plot(measure1$Time, measure1$O2_3N, type = "l",ylab = "Concentration en oxygène (mg/L)", xlab="Temps")
...
plot(measure1$Time, measure1$O2_4N, type = "l", ylab = "Concentration en oxygène (mg/L)", xlab = "Temps")
...
plot(measure1$Time, measure1$O2_5N, type = "l",ylab = "Concentration en oxygène (mg/L)", xlab = "Temps")
...
plot(measure1$Time, measure1$O2_6N, type = "l",ylab = "Concentration en oxygène (mg/L)", xlab = "Temps")
...
Vous trouvez un court tutoriel qui présente : 
